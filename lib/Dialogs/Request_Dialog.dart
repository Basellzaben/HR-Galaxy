...
class Request_Dialog extends StatefulWidget {
  const Request_Dialog({Key? key}) : super(key: key);

  @override
  _Request_DialogState createState() => _Request_DialogState();
}

class _Request_DialogState extends State<Request_Dialog> {
    ...
    return Directionality(
      ...
      child: Container(
          ...
          child: AlertDialog(
            ...
            title: Text(
              LanguageProvider.Llanguage('Order'),
            ...
            content: Container(
              height: 350,
              child: Scaffold(
                body: Consumer<My_Request_ViewModel>(
                  ...
                  switch (value.AllRequst.status) {
                    ...
                    case Status.ERROR:
                      return Center(
                          child: Text(value.AllRequst.message.toString()));
                              ...
                              child: Card(
                                  child: Container(
                                      ...
                                      child: Text(
                                        ...
                                        langg=="EN"?value.AllRequst.data!.list![index]
                                            .englishDescription!:value.AllRequst.data!.list![index]
                                            .arabicDescription!,
