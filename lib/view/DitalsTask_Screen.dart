...
// ignore_for_file: camel_case_types, library_private_types_in_public_api, non_constant_identifier_names, deprecated_member_use, unused_local_variable, prefer_typing_uninitialized_variables, unrelated_type_equality_checks
...
class DitalsTask_Screen extends StatefulWidget {
  const DitalsTask_Screen({Key? key}) : super(key: key);

  @override
  _DitalsTask_ScreenState createState() => _DitalsTask_ScreenState();
}

class _DitalsTask_ScreenState extends State<DitalsTask_Screen> {
                                          ...
                                          Container(
                                            ...
                                            child: textWidget(
                                                ...
                                                value.TaskDatadetails.data!.list![0]
                                                    .fromEmpName!:value.TaskDatadetails.data!.list![0]
                                                    .fromEmpNameEN!,
                                                14,
                                                FontWeight.w500,
                                                Colors.black),
                                            ...
                                            child: context.read<My_Request_ViewModel>().TypeRequset=="1"?Row(
                                              ...
                                              children: [
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: SvgPicture.asset(
                                                    ...
                                                    color: int.parse(value.TaskDatadetails.data!
                                                        .list![0].wfAction!) ==5?Colors.grey:
                                                    int.parse(value.TaskDatadetails.data!
                                                        .list![0].wfAction!) ==1?Colors.green:Colors.red,
                                                    width:
                                              ...
                                              children: [
                                                SizedBox(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      textWidget(str.length>0?starttime[0].trim():"", 18/sc, FontWeight.w800,
                                                          ColorTheme(context)),
                                                      textWidget(str.length>0?starttime[1].trim():"", 28/sc, FontWeight.w800,
                                                          ColorTheme(context)),
                                                      /*  Row(
                                                        children: [
                                                ...
                                                SizedBox(
                                                  ...
                                                  child:  Row(
                                                    children: [
                                                      textWidget(formatter.format(int.parse(LeaveDay)).toString(), 40/sc, FontWeight.w800, ColorTheme(context)),
                                                      const SizedBox(width: 5),
                                                      Column(
                                                        children: [
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  ...
                                                  textWidget(    int.parse(value.TaskDatadetails.data!
                                                      .list![0].wfAction!) ==
                                                      5
                                            ...
                                            child: Stack(
                                              children: [
                                                Align(
                                                  alignment: Alignment.topLeft,
                                                  child: textWidget(
                                                      value.TaskDatadetails.data!.list![0].wfRequestID ==
                                                          1
                                                          ? value.TaskDatadetails.data!.list![0]
                                                          .vNotes!
                                                          : value.TaskDatadetails.data!.list![0]
